...
- Domains by lab, so far: 01 payroll, 02 payroll, 03 commerce, 04 commerce,
  ...
  fresh rather than imported, per the independent-labs principle, 28 a
  ...
  independent-labs principle. Lab 28 is its own third fully independent
  ...
  25's, or 26's), and is the first lab in this repository to add real
...
- Lab 28 adds no new shared-package code and made no changes under
  ...
  cascading-replica needs may turn out to want a still-different shape of
  these primitives.
