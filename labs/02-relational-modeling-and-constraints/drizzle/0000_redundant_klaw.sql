...
CREATE TABLE IF NOT EXISTS "employees" (
	...
	CONSTRAINT "employees_annual_salary_cents_positive" CHECK ("employees"."annual_salary_cents" > 0),
	CONSTRAINT "employees_employment_status_valid" CHECK ("employees"."employment_status" in ('active', 'terminated'))
);
--> statement-breakpoint
DO $$ BEGIN
